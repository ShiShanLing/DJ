...
@interface DJMyTaskViewController ()<UITableViewDelegate, UITableViewDataSource, DJTaskTypeChooseViewDelegate>
...
@implementation DJMyTaskViewController{
...
- (void)viewDidLoad {
    ...
    _defaultNavigationBarView.titleLabel.text = @"我的任务";
...
- (void)handleReturnBtn {
    ...
    if ([self.tagState isEqualToString:@"sidebar"]) {
