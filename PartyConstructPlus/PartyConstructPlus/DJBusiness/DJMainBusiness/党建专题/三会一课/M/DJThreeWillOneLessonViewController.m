//
//  DJThreeWillOneLessonViewController.m
//  PartyConstructPlus
//
...
@interface DJThreeWillOneLessonViewController ()<UITableViewDelegate, UITableViewDataSource, DJTaskTypeChooseViewDelegate>
...
@implementation DJThreeWillOneLessonViewController{
...
- (void)viewDidLoad {
    ...
    _defaultNavigationBarView.titleLabel.text = @"三会一课";
...
-(void)requestMyTaskList:(NSInteger)num taskState:(NSString *)taskState time:(NSString *)time{
    ...
    [URL_Dic setObject:@"C" forKey:@"tag"];
    [self showHud:@"" title:@""];
