//
//  DJTaskTwoLearnOneDoViewController.m
//  PartyConstructPlus
//
...
@interface DJTaskTwoLearnOneDoViewController ()<UITableViewDelegate, UITableViewDataSource, DJTaskTypeChooseViewDelegate>
...
@implementation DJTaskTwoLearnOneDoViewController{
...
-(void)requestMyTaskList:(NSInteger)num taskState:(NSString *)taskState time:(NSString *)time{
    ...
    [URL_Dic setObject:@"B" forKey:@"tag"];
    [self showHud:@"" title:@""];
