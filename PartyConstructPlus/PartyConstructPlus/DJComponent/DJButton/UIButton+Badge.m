...
//  PartyConstruct
//
//  Created by HzCitizen on 16/7/26.
...
- (void)badgeInit {
    ...
    self.badgePadding   = 6;
    self.badgeMinSize   = 8;
    self.badgeOriginX   = self.frame.size.width/2+10;
    self.badgeOriginY   = 30;
...
- (void)removeBadge
{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        weakself.badge.transform = CGAffineTransformMakeScale(0, 0);
    } completion:^(BOOL finished) {
        [weakself.badge removeFromSuperview];
        weakself.badge = nil;
    }];
}
