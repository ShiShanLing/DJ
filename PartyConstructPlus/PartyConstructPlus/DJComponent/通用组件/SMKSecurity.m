...
@implementation SMKSecurity

+ (SMKSecurity *)sharedInstance
{
    static SMKSecurity *_securiryUtilManager = nil;
...
+(BOOL)isJailBreak
{
    return  ([SMKSecurity isJailBreakWithAllAppName] || [SMKSecurity isJailBreakWithCydia]);
}
